...
public class Table implements java.io.Serializable {
    ...
    public Table(String name, int pk_index) {
        ...
        gridIndices_colNames = new Vector<String[]>();
        hasGrid = false;
                ...
                if (i == (pagesID.size() - 1)) {
                    ...
                    if (countRows < maxRows) {
                        ...
                        // then insert into the last page ( not the new one)
                            ...
                            System.out.println(to_be_shifted.toString() + " shifted row");
...
// GridIndex tempG = (GridIndex) DBApp.deserialize(tableName + "-GI" + i);
            ...
            String[] tempG = gridIndices_colNames.get(i);
            String[] colNames = tempG; //colName of the Grid

            int tempSize = tempG.length;
            int tempCount = 0;
...
//            }
        ...
        GridIndex idxFound = null;
        if (G != -1)
            idxFound = (GridIndex) DBApp.deserialize(tableName + "-GI" + G);
        return idxFound;
    }
...
//                }
    ...
    public void deleteUsingIndexForShfting(Hashtable<String, Object> colNameValue, Object pk_value, int pk_found, Vector<Vector> index_value) throws DBAppException, IOException {
        GridIndex G = chooseIndex(tableName, colNameValue);
...
// this is used to construct the hashtable:
    ...
    public void updateBucketAfterShiftingInInsert(Vector<Object> row) throws DBAppException, IOException {
        ...
        deleteUsingIndexForShfting(colNameValueDummy, row.get(pk_index), pk_index, index_valueDummy);
